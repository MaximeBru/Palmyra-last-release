      ...
      <!--           <div class="logo col-sm-1">
                ...
                <nav class="nav col-sm-11">
                  <ul class="main-nav">
                    ...
                    <li>
                      <a data-parent-menu="Careers" href="#">News</a>
                    </li>
                    <li>
                      <a data-parent-menu="News" href="#">Contact</a>
                    </li>
            ...
            <div class="row">
              <div class="col-sm-12">
                <ul>
                  <li><a href="#" title="Menu Item">Menu Item</a></li>
                  <li><a href="#" title="Menu Item">Menu Item</a></li>
                  <li><a href="#" title="Menu Item">Menu Item 1</a></li>
                  <li><a href="#" title="Menu Item">Menu Item</a></li>
                  <li><a href="#" title="Menu Item">Menu Item</a></li>
                  <li><a href="#" title="Menu Item">Menu Item</a></li>
                </ul>
        ...
        <div id="Company-sub-menu" class="sub-menu">
          <div class="container">
            <div class="row">
              <div class="col-sm-12">
                <ul id="imgNav">
<li><a href="#" title="Menu Item"><div class="imgNavContain"><img src="~/assets/images/security.jpg" alt=""><h3 class="imgNavTitle">Banquing</h3></div></a></li>
<li><a href="#" title="Menu Item"><div class="imgNavContain"><img src="~/assets/images/security.jpg" alt=""><h3 class="imgNavTitle">Insurance</h3></div></a></li>
<li><a href="#" title="Menu Item"><div class="imgNavContain"><img src="~/assets/images/security.jpg" alt=""><h3 class="imgNavTitle">Security</h3></div></a></li>
<li><a href="#" title="Menu Item"><div class="imgNavContain"><img src="~/assets/images/security.jpg" alt=""><h3 class="imgNavTitle">Lorem</h3></div></a></li>
</ul>
              </div>
            </div>
          </div>
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-12">
                <ul>
                  <li><a href="#" title="Menu Item">Menu Item</a></li>
                  <li><a href="#" title="Menu Item">Menu Item 3</a></li>
                  <li><a href="#" title="Menu Item">Menu Item</a></li>
                  <li><a href="#" title="Menu Item">Menu Item</a></li>
                  <li><a href="#" title="Menu Item">Menu Item</a></li>
                </ul>
            ...
            <div class="row">
              <div class="col-sm-12">
                <ul>
                  <li><a href="#" title="Menu Item">Menu Item</a></li>
                  <li><a href="#" title="Menu Item">Menu Item</a></li>
                  <li><a href="#" title="Menu Item">Menu Item 4</a></li>
                  <li><a href="#" title="Menu Item">Menu Item</a></li>
                  <li><a href="#" title="Menu Item">Menu Item</a></li>
                  <li><a href="#" title="Menu Item">Menu Item</a></li>
                </ul>
